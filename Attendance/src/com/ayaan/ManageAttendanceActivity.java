...
public class ManageAttendanceActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			adapter = new SimpleCursorAdapter(this, R.layout.display1, c,
					new String[] { "Sname", "Usn" }, new int[] { R.id.Sname,
							R.id.USN });
			setListAdapter(adapter);
			db.close();
		} catch (Exception e) {
			Toast.makeText(getApplicationContext(),
					"Could not retrieve Details", Toast.LENGTH_LONG).show();
		}
	}
		...
		alertDialog.setPositiveButton("YES",
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						Intent i = new Intent(ManageAttendanceActivity.this,
	...
	public void home_start(View v) {
		...
		if (!matcher.matches()) {
			Toast.makeText(getApplicationContext(), "Invalid Phone Id",
					Toast.LENGTH_LONG).show();
			return;
		}
		...
		try {
			...
			Toast.makeText(getApplicationContext(), "Exception Occured",
					Toast.LENGTH_LONG).show();
			return;
		}
		if (ssname.equals("") || ssusn.equals("") || sphone.equals("")) {
			if (ssname.equals("")) {
				Toast.makeText(getApplicationContext(),
						"Pls Fill in the Student Name!", Toast.LENGTH_LONG)
						.show();
			} else if (ssusn.equals("")) {
				Toast.makeText(getApplicationContext(),
						"Pls Fill in the Student Usn!", Toast.LENGTH_LONG)
						.show();
			} else {
				Toast.makeText(getApplicationContext(),
						"Pls Enter the Phone No!", Toast.LENGTH_LONG).show();
			}
			...
			try {
				...
				Toast.makeText(getApplicationContext(),
						"Unable to Insert Pls Try again!!", Toast.LENGTH_LONG)
						.show();
			}
		}
