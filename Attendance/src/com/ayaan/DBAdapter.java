...
public class DBAdapter {
	...
	private static final String DATABASE_CREATE1 = "create table stu_info (_id integer primary key autoincrement, Sname text not null, Usn text not null, Code text not null, Attended integer, Missed integer, Phone text not null);";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("insert into fac_info values('1','Arjun','123','17520')");
			db.execSQL("insert into stu_info values('1','A Ram','3401','17520','0','0','0')");
			db.execSQL("insert into stu_info values('2','A Ram','3402','17520','0','0','0')");
			db.execSQL("insert into stu_info values('3','A Ram','3403','17520','0','0','0')");
			db.execSQL("insert into stu_info values('4','A Ram','3404','17520','0','0','0')");
			db.execSQL("insert into stu_info values('5','A Ram','3405','17520','0','0','0')");
			
			db.execSQL("insert into stu_info values('6','A Ram','3406','17520','0','0','0')");
			db.execSQL("insert into stu_info values('7','A Ram','3407','17520','0','0','0')");
			db.execSQL("insert into stu_info values('8','A Ram','3408','17520','0','0','0')");
			db.execSQL("insert into stu_info values('9','A Ram','3409','17520','0','0','0')");
			db.execSQL("insert into stu_info values('10','A Ram','3410','17520','0','0','0')");
