	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Toast.makeText(getApplicationContext(),
					"Could not retrieve Student Details", Toast.LENGTH_LONG)
					.show();
		}
		try {
			setListAdapter(new ArrayAdapter<String>(this,android.R.layout.simple_list_item_checked, new ArrayList()));
			//setListAdapter(new ArrayAdapter<String>(this,R.layout.attendance_item_view,R.id.name, new ArrayList()));
...
//	}
	...
	public void submit(View v) {
		...
		try {
			...
			Toast.makeText(getApplicationContext(), "submit", Toast.LENGTH_LONG)
					.show();
			db.close();
		} catch (Exception e) {
		...
		Intent i = new Intent(AttendanceActivity.this, ManageActivity.class);
		finish();
		startActivity(i);
	}
	...
	/*public void sendSMS(String phoneNumber, String message) {
		...
		PendingIntent sentPI = PendingIntent.getBroadcast(
				AttendanceActivity.this, 0, new Intent(SENT), 0);

		PendingIntent deliveredPI = PendingIntent.getBroadcast(
				AttendanceActivity.this, 0, new Intent(DELIVERED), 0);
